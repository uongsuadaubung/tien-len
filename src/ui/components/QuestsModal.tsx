...
/**
 * Trọng số ưu tiên hiển thị:
 * 0: Đã hoàn thành & Đang chờ nhận thưởng (Lên đầu tiên)
 * 1: Đang làm (Sắp xếp theo % tiến độ cao nhất)
 * 2: Đã nhận thưởng xong (Đẩy xuống cuối cùng)
 */
...
export const QuestsModal: React.FC<QuestsModalProps> = ({
  ...
  // Sắp xếp Nhiệm Vụ Ngày: Đã hoàn thành chờ nhận lên đầu -> Đang làm -> Đã nhận
