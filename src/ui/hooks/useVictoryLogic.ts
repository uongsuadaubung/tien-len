...
export function useVictoryLogic(props: UseVictoryLogicProps): VictoryLogicResult {
  ...
  const {
    ...
    isThreeSpadesWin: rawStoreIsThreeSpadesWin = false,
    matchPayouts: payouts,
    loanDeductionAmount: rawStoreLoanDeduction = 0,
  ...
  const settlement: PerspectiveMatchSettlement = useMemo(() => {
    ...
    const basePerspectiveParams = {
      ...
      loanDeduction: rawStoreLoanDeduction,
      isThreeSpadesWin: rawStoreIsThreeSpadesWin,
    ...
    eloDelta,
    lastEloBreakdown,
    rawStoreLoanDeduction,
    rawStoreIsThreeSpadesWin,
  ...
  return {
    ...
    isThreeSpadesWin: settlement.isThreeSpadesWin,
    betAmount,
    activeGameType,
