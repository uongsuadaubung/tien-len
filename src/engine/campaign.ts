...
export function createCampaignBotEntity(botConfig: CampaignBotConfig, ecosystemBots?: BotEntity[]): BotEntity {
  ...
  return {
    ...
    createdAt: Date.now(),
    memoryDepth: botConfig.memoryDepth,
    riskAppetite: botConfig.riskAppetite,
    trapTendency: botConfig.trapTendency,
    baitingTendency: botConfig.baitingTendency,
    antiLeaderAggression: botConfig.antiLeaderAggression,
    tempoControl: botConfig.tempoControl,
    damageControl: botConfig.damageControl,
    turnsToWinLookahead: botConfig.turnsToWinLookahead,
    dynamicHandSacrifice: botConfig.dynamicHandSacrifice,
    bombInferenceRate: botConfig.bombInferenceRate,
    semiCooperativeCooperation: botConfig.semiCooperativeCooperation,
    positionalAwareness: botConfig.positionalAwareness,
    inMatchAdaptationRate: botConfig.inMatchAdaptationRate,
    mctsSimulations: botConfig.mctsSimulations,
    handPartitioningOptimality: botConfig.handPartitioningOptimality,
    simulationLookahead: botConfig.simulationLookahead,
    useMinimaxEndgame: botConfig.useMinimaxEndgame,
    useBayesianInference: botConfig.useBayesianInference,
    useDynamicRepartitioning: botConfig.useDynamicRepartitioning,
    currentStreak: 2,
    highestStreak: 6,
    stats: {
      gamesPlayed: 120,
