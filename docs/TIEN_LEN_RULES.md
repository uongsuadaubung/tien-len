# ĐẶC TẢ LUẬT CHƠI TIẾN LÊN MIỀN NAM CHUẨN (VIETNAMESE TIEN LEN MASTER RULES)

---

## 1. TỔNG QUAN & BỘ BÀI (OVERVIEW & CARD DECK)

- **Số người chơi**: 4 người (mỗi người 13 lá từ bộ bài Tây 52 lá). Hỗ trợ chơi Solo 1v1 (13 lá/người) hoặc Bàn 3 người.
- **Độ lớn của số (Rank)**:
...
- **Quy tắc so sánh 2 lá bài đơn**:
  ...
  - Ví dụ: $3\heartsuit > 3\diamondsuit > 3\clubsuit > 3\spadesuit$. $4\spadesuit > 3\heartsuit$. $2\heartsuit$ là lá bài tối cao trong bộ bài.
...
| :--- | :--- | :--- | :--- |
| **Rác (Single)** | 1 lá bài đơn lẻ | $3\spadesuit, K\heartsuit, 2\diamondsuit$ | So rank, sau đó so chất |
...
| **Sảnh Rồng** | Sảnh liên tiếp 12-13 lá (3 đến A/2) | $3 \to A$ hoặc $3 \to 2$ | Tới trắng |

> [!IMPORTANT]
> **Quy định về Sảnh**: Sảnh hợp lệ có độ dài từ 3 đến 12 lá. **Sảnh không được phép chứa lá 2 (Heo)** (không có sảnh $K\text{-}A\text{-}2$ hay $A\text{-}2\text{-}3$).
...
### 3.2. Bảng Quy Tắc Chặt Heo & Chặt Hàng

| Bộ trên bàn | Các bộ có thể Chặt | Vòng chơi & Điều kiện |
| :--- | :--- | :--- |
| **1 Heo (2 bất kỳ)** | - 1 Heo lớn hơn<br>- 3 Đôi Thông<br>- Tứ Quý<br>- 4 Đôi Thông | - 3 Đôi Thông: **phải theo vòng**<br>- Tứ Quý: **phải theo vòng**<br>- 4 Đôi Thông: **chặt tự do không cần vòng (nhảy cóc)** |
...
| **4 Đôi Thông** | - 4 Đôi Thông lớn hơn | **Chặt tự do không cần theo vòng** |

### 3.3. Quy tắc Chặt Chồng (Chặt đè)
- Khi một người chặt Heo/Hàng, người kế tiếp có thể tiếp tục chặt đè bằng hàng lớn hơn.
- Toàn bộ tiền phạt/điểm tích lũy từ các lần chặt trước sẽ do **người bị chặt cuối cùng gánh chịu** toàn bộ cho người chặt thành công sau cùng.
...
- Một vòng đấu kết thúc khi **tất cả người chơi khác đều bỏ lượt**. Người đánh ra bộ bài cuối cùng sẽ giành quyền mở vòng mới ("Cầm Cái") và có thể đánh ra bất kỳ bộ bài hợp lệ nào.

---

## 5. CÁC LUẬT ĐẶC BIỆT & TÙY CHỌN (SPECIAL & CUSTOM RULES)

### 5.1. Luật Cấm Đánh 2 Cuối Cùng & Thối Heo (`prohibitEndingWithTwo`)
- **Định nghĩa**: Người chơi **không được phép đánh quân 2 (Heo) hoặc tổ hợp chứa Heo ở lượt đánh cuối cùng để kết thúc bài (về Nhất)**.
- **Xử lý nếu bị kẹt**: Người chơi chỉ còn lại Heo/Đôi Heo trên tay bắt buộc phải Bỏ Lượt (Pass).
- **Phạt Thối Heo**: Khi có người chơi khác về Nhất, người bị kẹt Heo sẽ bị xử thua và phạt tiền Thối Heo:
  - Heo Đen ($2\spadesuit, 2\clubsuit$): Phạt $0.5 \times \text{Mức cược}$.
...
Xử thắng ngay sau khi chia bài mà không cần đánh ván đấu:
1. **Sảnh Rồng**: Sảnh 12-13 lá ($3 \to A$ hoặc $3 \to 2$).
2. **Tứ Quý 2**: Cầm trọn 4 con heo ($2\spadesuit 2\clubsuit 2\diamondsuit 2\heartsuit$).
3. **5 Đôi Thông**: 5 đôi liên tiếp.
4. **6 Đôi Bất Kỳ**: 6 đôi bất kỳ trên tay 13 lá.
5. **13 Lá Đồng Màu**: 13 lá toàn Đỏ hoặc toàn Đen.
6. **Tứ Quý 3 ở Ván Đầu Tiên**: Cầm 4 con 3 ở ván mở màn.

### 5.4. Luật Chống Đền Bài Khi Báo 1 Lá (Anti-Leader Intercept Rule)
