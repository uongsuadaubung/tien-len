...
### Căn cứ phân hệ: [`src/ai/decision-maker.ts`](file:///c:/Users/kien.hm/Desktop/tien-len/src/ai/decision-maker.ts) & [`src/ai/rule-strategies.ts`](file:///c:/Users/kien.hm/Desktop/tien-len/src/ai/rule-strategies.ts)
...
1. **Composite Rule Strategy Pattern ([`CompositeRuleStrategy`](file:///c:/Users/kien.hm/Desktop/tien-len/src/ai/rule-strategies.ts))**: Phân tích tập hợp các Rule đang active (`GameRules`) để tổng hợp:
...
│    - GameFlow: prohibitEndingWithTwo / firstGameRequireThreeOfSpades                   │
...
2. **Cờ tàn 2 lá không cấm 2 cuối**:
